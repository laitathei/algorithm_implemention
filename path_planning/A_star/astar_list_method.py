...
def astar(maze, start, end):
    ...
    while len(open_list) > 0:
        ...
        # for i in range (len(children_copy)):
        #     for j in range (len(close_list)):

        #         if children_copy[i][1][1] == close_list[j][1][1]:
        #             del children[i:i+1]
        #             continue
        ...
        #         if children_copy[i][1][1] == open_list[k][1][1]:
        #             del children[i:i+1]
        #             continue
...
while True:
    ...
    for event in pygame.event.get():
        ...
        if mouse_count == 2 and start == True:
            tmp = []
            path, tmp, close_list = astar(simulation_screen_array,start_point,end_point)
